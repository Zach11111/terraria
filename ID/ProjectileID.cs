...
namespace Terraria.ID
{
  public class ProjectileID
  {
    ...
    {
      public static SetFactory Factory = new SetFactory((int) ProjectileID.Count);
      public static SettingsForCharacterPreview[] CharacterPreviewAnimations = ProjectileID.Sets.Factory.CreateCustomSet<SettingsForCharacterPreview>(new SettingsForCharacterPreview(), (object) (short) 111, (object) ProjectileID.Sets.SimpleLoop(0, 6).WithOffset(6f, 0.0f).WhenNotSelected(new int?(0), new int?(0)).WithSpriteDirection(-1), (object) (short) 112, (object) ProjectileID.Sets.SimpleLoop(0, 3, 5).WhenNotSelected(new int?(0), new int?(0)).WithSpriteDirection(-1), (object) (short) sbyte.MaxValue, (object) ProjectileID.Sets.SimpleLoop(0, 5).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-6f, 0.0f).WithSpriteDirection(-1), (object) (short) 175, (object) ProjectileID.Sets.SimpleLoop(0, 2, 8).WhenNotSelected(new int?(0), new int?(2), new int?(10)).WithOffset(-4f, -6f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 197, (object) ProjectileID.Sets.SimpleLoop(0, 0).WithOffset(-8f, -4f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking)), (object) (short) 198, (object) ProjectileID.Sets.SimpleLoop(0, 4).WhenNotSelected(new int?(0), new int?(4), new int?(4)).WithOffset(-8f, -20f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 199, (object) ProjectileID.Sets.SimpleLoop(0, 8, 6).WhenNotSelected(new int?(0), new int?(8), new int?(6)).WithOffset(-2f, -18f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 200, (object) ProjectileID.Sets.SimpleLoop(0, 6, 5).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-2f, 0.0f).WithSpriteDirection(-1), (object) (short) 208, (object) ProjectileID.Sets.SimpleLoop(1, 4, 5).WhenNotSelected(new int?(1), new int?(4), new int?(7)).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 209, (object) ProjectileID.Sets.SimpleLoop(2, 10, 5).WhenNotSelected(new int?(0), new int?(0)).WithOffset(6f, 0.0f).WithSpriteDirection(-1), (object) (short) 210, (object) ProjectileID.Sets.SimpleLoop(1, 6, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(4f, 0.0f).WithSpriteDirection(-1), (object) (short) 236, (object) ProjectileID.Sets.SimpleLoop(2, 7, 5).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-16f, 0.0f).WithSpriteDirection(-1), (object) (short) 268, (object) ProjectileID.Sets.SimpleLoop(0, 6, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(4f, 0.0f).WithSpriteDirection(-1), (object) (short) 269, (object) ProjectileID.Sets.SimpleLoop(0, 4, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(0.0f, 0.0f).WithSpriteDirection(-1), (object) (short) 313, (object) ProjectileID.Sets.SimpleLoop(0, 4, 5).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-6f, 0.0f).WithSpriteDirection(-1), (object) (short) 314, (object) ProjectileID.Sets.SimpleLoop(1, 6, 5).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-4f, 0.0f).WithSpriteDirection(-1), (object) (short) 319, (object) ProjectileID.Sets.SimpleLoop(2, 4, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-14f, 0.0f).WithSpriteDirection(-1), (object) (short) 324, (object) ProjectileID.Sets.SimpleLoop(2, 4, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-4f, 0.0f).WithSpriteDirection(-1), (object) (short) 334, (object) ProjectileID.Sets.SimpleLoop(2, 5, 5).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-10f, 0.0f).WithSpriteDirection(-1), (object) (short) 353, (object) ProjectileID.Sets.SimpleLoop(2, 8, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(4f, 0.0f).WithSpriteDirection(-1), (object) (short) 380, (object) ProjectileID.Sets.SimpleLoop(0, 4, 6).WithOffset(-10f, -20f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 398, (object) ProjectileID.Sets.SimpleLoop(1, 5, 7).WhenNotSelected(new int?(0), new int?(0)).WithOffset(6f, 0.0f), (object) (short) 499, (object) ProjectileID.Sets.SimpleLoop(2, 6, 7).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-18f, 0.0f).WithSpriteDirection(-1), (object) (short) 653, (object) ProjectileID.Sets.SimpleLoop(0, 0).WithOffset(-2f, 0.0f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.CompanionCubePet)), (object) (short) 703, (object) ProjectileID.Sets.SimpleLoop(0, 4).WhenNotSelected(new int?(0), new int?(4), new int?(4)).WithOffset(4f, -10f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 701, (object) ProjectileID.Sets.SimpleLoop(0, 3, 6).WhenNotSelected(new int?(0), new int?(3), new int?(6)).WithOffset(-2f, -18f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 764, (object) ProjectileID.Sets.SimpleLoop(0, 0).WithOffset(2f, -18f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.EtsyPet)), (object) (short) 765, (object) ProjectileID.Sets.SimpleLoop(2, 4, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-4f, 0.0f).WithSpriteDirection(-1), (object) (short) 774, (object) ProjectileID.Sets.SimpleLoop(4, 4, 6).WithOffset(-14f, -24f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 825, (object) ProjectileID.Sets.SimpleLoop(14, 6, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-6f, 0.0f).WithSpriteDirection(-1), (object) (short) 821, (object) ProjectileID.Sets.SimpleLoop(13, 6, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(0.0f, 0.0f).WithSpriteDirection(-1), (object) (short) 815, (object) ProjectileID.Sets.SimpleLoop(0, 6, 6).WhenNotSelected(new int?(0), new int?(6), new int?(6)).WithOffset(-20f, -30f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 816, (object) ProjectileID.Sets.SimpleLoop(4, 7, 6).WhenNotSelected(new int?(0), new int?(0)).WithOffset(-10f, 0.0f).WithSpriteDirection(-1), (object) (short) 817, (object) ProjectileID.Sets.SimpleLoop(0, 3, 6, true).WithSpriteDirection(-1).WithOffset(-6f, -12f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 854, (object) ProjectileID.Sets.SimpleLoop(0, 4, 6).WithOffset(6f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(4), new int?(9), new int?(4)), (object) (short) 858, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(-6f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(2), new int?(8), new int?(4)), (object) (short) 859, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(4f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(5), new int?(13), new int?(3)), (object) (short) 860, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(2f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(5), new int?(1)), (object) (short) 875, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(4f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(0), new int?(7), new int?(4)), (object) (short) 881, (object) ProjectileID.Sets.SimpleLoop(0, 1).WhenSelected(new int?(1), new int?(5), new int?(6)).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.SlimePet)), (object) (short) 882, (object) ProjectileID.Sets.SimpleLoop(0, 6, 5).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 883, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(2f, -8f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.WormPet)), (object) (short) 884, (object) ProjectileID.Sets.SimpleLoop(0, 1).WhenSelected(new int?(2), new int?(7), new int?(5)), (object) (short) 885, (object) ProjectileID.Sets.SimpleLoop(0, 5, 5).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking)), (object) (short) 886, (object) ProjectileID.Sets.SimpleLoop(0, 8).WithOffset(4f, -16f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 887, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(2f, -8f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.WormPet)), (object) (short) 888, (object) ProjectileID.Sets.SimpleLoop(0, 6, 5).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 889, (object) ProjectileID.Sets.SimpleLoop(0, 5, 5).WithOffset(4f, -16f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking)), (object) (short) 890, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(2f, 0.0f).WhenSelected(new int?(2), new int?(6), new int?(5)), (object) (short) 892, (object) ProjectileID.Sets.SimpleLoop(0, 6, 6).WithOffset(-4f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 893, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(0.0f, -8f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.WormPet)), (object) (short) 894, (object) ProjectileID.Sets.SimpleLoop(0, 8).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 897, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(2f, 0.0f).WhenSelected(new int?(2), new int?(6), new int?(5)), (object) (short) 898, (object) ProjectileID.Sets.SimpleLoop(0, 16, 5).WithOffset(-2f, -16f), (object) (short) 899, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(2f, 0.0f).WhenSelected(new int?(2), new int?(7), new int?(4)), (object) (short) 900, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(6f, 0.0f).WhenSelected(new int?(2), new int?(7), new int?(4)), (object) (short) 901, (object) ProjectileID.Sets.SimpleLoop(0, 5).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 934, (object) ProjectileID.Sets.SimpleLoop(0, 1).WhenSelected(new int?(1), new int?(5), new int?(5)).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.SlimePet)), (object) (short) 956, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(0.0f, 0.0f).WhenSelected(new int?(1), new int?(8), new int?(4)).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.BerniePet)), (object) (short) 957, (object) ProjectileID.Sets.SimpleLoop(0, 24, 3).WithOffset(0.0f, -14f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.Float)), (object) (short) 958, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(-2f, 0.0f).WhenSelected(new int?(5), new int?(8), new int?(4)), (object) (short) 959, (object) ProjectileID.Sets.SimpleLoop(0, 1).WhenSelected(new int?(1), new int?(7), new int?(4)).WithOffset(4f, 0.0f), (object) (short) 960, (object) ProjectileID.Sets.SimpleLoop(0, 4).WithOffset(4f, 0.0f).WhenSelected(new int?(5), new int?(7), new int?(4)), (object) (short) 994, (object) ProjectileID.Sets.SimpleLoop(0, 4, 5).WithOffset(2f, 0.0f).WhenSelected(new int?(5), new int?(7), new int?(5)), (object) (short) 998, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(6f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(0), new int?(6), new int?(5)), (object) (short) 1003, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(2f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(2), new int?(9), new int?(4)), (object) (short) 1004, (object) ProjectileID.Sets.SimpleLoop(0, 1).WithOffset(-2f, 0.0f).WithSpriteDirection(-1).WhenSelected(new int?(2), new int?(7), new int?(4)), (object) (short) 1018, (object) ProjectileID.Sets.SimpleLoop(0, 0).WithOffset(8f, 0.0f).WithCode(new SettingsForCharacterPreview.CustomAnimationCode(DelegateMethods.CharacterPreview.CompanionCubePet)));
      public static bool[] DontApplyParryDamageBuff = ProjectileID.Sets.Factory.CreateBoolSet(false, 524, 321, 181, 566);
      public static bool[] IsAGravestone = ProjectileID.Sets.Factory.CreateBoolSet(false, 202, 201, 204, 43, 203, 205, 527, 528, 529, 530, 531);
      public static bool[] IsAWhip = ProjectileID.Sets.Factory.CreateBoolSet(false, 847, 841, 848, 849, 912, 913, 914, 915, 952);
      public static bool[] AllowsContactDamageFromJellyfish = ProjectileID.Sets.Factory.CreateBoolSet(false, 972, 982, 984, 997);
      public static bool[] ImmediatelyUpdatesNPCBuffFlags = ProjectileID.Sets.Factory.CreateBoolSet(636);
      public static bool[] IsAnNPCAttachedExplosive = ProjectileID.Sets.Factory.CreateBoolSet(636);
      ...
      public static float[] YoyosLifeTimeMultiplier = ProjectileID.Sets.Factory.CreateFloatSet(-1f, 541f, 3f, 548f, 5f, 542f, 7f, 543f, 6f, 544f, 8f, 534f, 9f, 564f, 11f, 999f, 11f, 545f, 13f, 563f, 10f, 562f, 8f, 553f, 12f, 546f, 16f, 552f, 15f, 549f, 14f);
      public static float[] YoyosMaximumRange = ProjectileID.Sets.Factory.CreateFloatSet(200f, 541f, 130f, 548f, 170f, 542f, 195f, 543f, 207f, 544f, 215f, 534f, 220f, 564f, 225f, 999f, 225f, 545f, 235f, 562f, 235f, 563f, 250f, 546f, 275f, 552f, 270f, 553f, 275f, 547f, 280f, 549f, 290f, 554f, 340f, 550f, 370f, 551f, 370f, 555f, 360f, 603f, 400f);
      ...
      public static float[] YoyosTopSpeed = ProjectileID.Sets.Factory.CreateFloatSet(10f, 541f, 9f, 548f, 11f, 542f, 12.5f, 543f, 12f, 544f, 13f, 534f, 13f, 564f, 14f, 999f, 14f, 545f, 14f, 562f, 15f, 563f, 12f, 546f, 17f, 552f, 14f, 553f, 15f, 547f, 17f, 549f, 16f, 554f, 16f, 550f, 16f, 551f, 16f, 555f, 16.5f, 603f, 17.5f);
      ...
      public static bool[] HeldProjDoesNotUsePlayerGfxOffY = ProjectileID.Sets.Factory.CreateBoolSet(947, 948, 25, 26, 35, 63, 154, 247, 757, 699);
      public static bool[] DontCancelChannelOnKill = ProjectileID.Sets.Factory.CreateBoolSet(190);
      ...
      public static bool[] NoMeleeSpeedVelocityScaling = ProjectileID.Sets.Factory.CreateBoolSet(false, 699, 707, 877, 878, 879, 985, 973);
      public static int[] DrawScreenCheckFluff = ProjectileID.Sets.Factory.CreateIntSet(480, 461, 1600, 632, 1600, 447, 1600, 455, 2400, 754, 1600, 872, 1600, 873, 1600, 871, 1600, 919, 2400, 923, 2400, 931, 960, 16, 960, 34, 960, 79, 960, 933, 480, 642, 2400, 106, 960, 1020, 960);
      public static bool[] CanHitPastShimmer = ProjectileID.Sets.Factory.CreateBoolSet(605, 270, 719, 961, 962, 926, 922, 100, 84, 83, 96, 101, 102, 275, 276, 277, 258, 259, 384, 385, 386, 874, 872, 873, 871, 683, 676, 670, 675, 686, 687, 467, 468, 464, 465, 466, 526, 456, 462, 455, 452, 454, 949);

      public static SettingsForCharacterPreview SimpleLoop(
        int startFrame,
        int frameCount,
        int delayPerFrame = 4,
        bool bounceLoop = false)
      {
        if (frameCount < 1)
          frameCount = 1;
        SettingsForCharacterPreview characterPreview = new SettingsForCharacterPreview();
        characterPreview.Offset = Vector2.Zero;
        characterPreview.SpriteDirection = 1;
        characterPreview.WhenSelected(new int?(startFrame), new int?(frameCount), new int?(delayPerFrame), new bool?(bounceLoop));
        characterPreview.WhenNotSelected(new int?(startFrame), new int?(frameCount), new int?(delayPerFrame), new bool?(bounceLoop));
