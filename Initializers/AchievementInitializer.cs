...
namespace Terraria.Initializers
{
  public class AchievementInitializer
  {
    public static void Load()
    {
      ...
      Achievement achievement90 = new Achievement("DEFEAT_EMPRESS_OF_LIGHT");
      achievement90.AddCondition(NPCKilledCondition.Create((short) 636));
      Main.Achievements.Register(achievement90);
      Achievement achievement91 = new Achievement("DEFEAT_QUEEN_SLIME");
      achievement91.AddCondition(NPCKilledCondition.Create((short) 657));
      Main.Achievements.Register(achievement91);
      Achievement achievement92 = new Achievement("DEFEAT_DREADNAUTILUS");
      achievement92.AddCondition(NPCKilledCondition.Create((short) 618));
      Main.Achievements.Register(achievement92);
      Achievement achievement93 = new Achievement("DEFEAT_OLD_ONES_ARMY_TIER3");
      achievement93.AddCondition((AchievementCondition) ProgressionEventCondition.Create(23));
      Main.Achievements.Register(achievement93);
      Achievement achievement94 = new Achievement("GET_ZENITH");
      achievement94.AddCondition(ItemPickupCondition.Create((short) 4956));
      Main.Achievements.Register(achievement94);
      Achievement achievement95 = new Achievement("GET_TERRASPARK_BOOTS");
      achievement95.AddCondition(ItemPickupCondition.Create((short) 5000));
      Main.Achievements.Register(achievement95);
      Achievement achievement96 = new Achievement("FLY_A_KITE_ON_A_WINDY_DAY");
      achievement96.AddCondition(CustomFlagCondition.Create("Use"));
      Main.Achievements.Register(achievement96);
      Achievement achievement97 = new Achievement("FOUND_GRAVEYARD");
      achievement97.AddCondition(CustomFlagCondition.Create("Reach"));
      Main.Achievements.Register(achievement97);
      Achievement achievement98 = new Achievement("GO_LAVA_FISHING");
      achievement98.AddCondition(CustomFlagCondition.Create("Do"));
      Main.Achievements.Register(achievement98);
      Achievement achievement99 = new Achievement("TURN_GNOME_TO_STATUE");
      achievement99.AddCondition((AchievementCondition) ProgressionEventCondition.Create(24));
      Main.Achievements.Register(achievement99);
      Achievement achievement100 = new Achievement("TALK_TO_NPC_AT_MAX_HAPPINESS");
      achievement100.AddCondition(CustomFlagCondition.Create("Do"));
      Main.Achievements.Register(achievement100);
      Achievement achievement101 = new Achievement("PET_THE_PET");
      achievement101.AddCondition(CustomFlagCondition.Create("Do"));
      Main.Achievements.Register(achievement101);
      Achievement achievement102 = new Achievement("FIND_A_FAIRY");
      achievement102.AddCondition(CustomFlagCondition.Create("Do"));
      Main.Achievements.Register(achievement102);
      Achievement achievement103 = new Achievement("THROW_A_PARTY");
      achievement103.AddCondition((AchievementCondition) ProgressionEventCondition.Create(25));
      Main.Achievements.Register(achievement103);
      ...
      AchievementManager achievements90 = Main.Achievements;
      int iconIndex90 = num90;
      int num91 = iconIndex90 + 1;
      achievements90.RegisterIconIndex("DEFEAT_QUEEN_SLIME", iconIndex90);
      AchievementManager achievements91 = Main.Achievements;
      int iconIndex91 = num91;
      int num92 = iconIndex91 + 1;
      achievements91.RegisterIconIndex("DEFEAT_EMPRESS_OF_LIGHT", iconIndex91);
      AchievementManager achievements92 = Main.Achievements;
      int iconIndex92 = num92;
      int num93 = iconIndex92 + 1;
      achievements92.RegisterIconIndex("GET_ZENITH", iconIndex92);
      AchievementManager achievements93 = Main.Achievements;
      int iconIndex93 = num93;
      int num94 = iconIndex93 + 1;
      achievements93.RegisterIconIndex("FIND_A_FAIRY", iconIndex93);
      AchievementManager achievements94 = Main.Achievements;
      int iconIndex94 = num94;
      int num95 = iconIndex94 + 1;
      achievements94.RegisterIconIndex("DEFEAT_DREADNAUTILUS", iconIndex94);
      AchievementManager achievements95 = Main.Achievements;
      int iconIndex95 = num95;
      int num96 = iconIndex95 + 1;
      achievements95.RegisterIconIndex("DEFEAT_OLD_ONES_ARMY_TIER3", iconIndex95);
      AchievementManager achievements96 = Main.Achievements;
      int iconIndex96 = num96;
      int num97 = iconIndex96 + 1;
      achievements96.RegisterIconIndex("FLY_A_KITE_ON_A_WINDY_DAY", iconIndex96);
      AchievementManager achievements97 = Main.Achievements;
      int iconIndex97 = num97;
      int num98 = iconIndex97 + 1;
      achievements97.RegisterIconIndex("TURN_GNOME_TO_STATUE", iconIndex97);
      AchievementManager achievements98 = Main.Achievements;
      int iconIndex98 = num98;
      int num99 = iconIndex98 + 1;
      achievements98.RegisterIconIndex("TALK_TO_NPC_AT_MAX_HAPPINESS", iconIndex98);
      AchievementManager achievements99 = Main.Achievements;
      int iconIndex99 = num99;
      int num100 = iconIndex99 + 1;
      achievements99.RegisterIconIndex("GET_TERRASPARK_BOOTS", iconIndex99);
      AchievementManager achievements100 = Main.Achievements;
      int iconIndex100 = num100;
      int num101 = iconIndex100 + 1;
      achievements100.RegisterIconIndex("THROW_A_PARTY", iconIndex100);
      AchievementManager achievements101 = Main.Achievements;
      int iconIndex101 = num101;
      int num102 = iconIndex101 + 1;
      achievements101.RegisterIconIndex("PET_THE_PET", iconIndex101);
      AchievementManager achievements102 = Main.Achievements;
      int iconIndex102 = num102;
      int num103 = iconIndex102 + 1;
      achievements102.RegisterIconIndex("GO_LAVA_FISHING", iconIndex102);
      AchievementManager achievements103 = Main.Achievements;
      int iconIndex103 = num103;
      int num104 = iconIndex103 + 1;
      achievements103.RegisterIconIndex("FOUND_GRAVEYARD", iconIndex103);
      AchievementManager achievements104 = Main.Achievements;
      ...
      Main.Achievements.RegisterAchievementCategory("DEFEAT_QUEEN_SLIME", category1);
      ...
      Main.Achievements.RegisterAchievementCategory("DEFEAT_EMPRESS_OF_LIGHT", category1);
      ...
      Main.Achievements.RegisterAchievementCategory("DEFEAT_OLD_ONES_ARMY_TIER3", category1);
      ...
      Main.Achievements.RegisterAchievementCategory("FOUND_GRAVEYARD", category2);
      ...
      Main.Achievements.RegisterAchievementCategory("GO_LAVA_FISHING", category3);
      ...
      Main.Achievements.RegisterAchievementCategory("TURN_GNOME_TO_STATUE", category3);
      Main.Achievements.RegisterAchievementCategory("TALK_TO_NPC_AT_MAX_HAPPINESS", category3);
      ...
      Main.Achievements.RegisterAchievementCategory("GET_ZENITH", category4);
