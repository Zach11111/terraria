...
namespace Terraria.Graphics.Light
{
  public class LegacyLighting : ILightingEngine
  {
    ...
    private void PreRenderPhase()
    {
      ...
      this._tileScanner.ExportTo(new Rectangle(x, y, num19 - x, num20 - y), this._lightMap, new TileLightScannerOptions()
      {
    ...
    private void DoColors()
    {
      if (this.IsColorOrWhiteMode)
      {
        ...
        else if ((double) this._blueWave < 0.97000002861022949)
        {
          ...
          for (int index1 = num2; index1 < num3; ++index1)
          {
            ...
            for (int index2 = num7; index2 != num8; index2 += num1)
            {
              ...
              if (!flag3 && (double) lightingState2.R2 <= (double) num4)
              {
                ...
                else if (lightingState1.WetLight)
                {
                  if (lightingState1.HoneyLight)
                    num4 *= (float) ((double) this._honeyLightR * (double) fastRandom.Next(98, 100) * 0.0099999997764825821);
                  else
                    num4 *= (float) ((double) this._wetLightR * (double) fastRandom.Next(98, 100) * 0.0099999997764825821);
                }
                else
                  num4 *= this._negLight;
              }
              ...
              if (!flag2 && (double) lightingState2.G2 <= (double) num5)
              {
                ...
                {
                  if (lightingState1.HoneyLight)
                    num5 *= (float) ((double) this._honeyLightG * (double) fastRandom.Next(97, 100) * 0.0099999997764825821);
                  else
                    num5 *= (float) ((double) this._wetLightG * (double) fastRandom.Next(97, 100) * 0.0099999997764825821);
                }
                else
                  num5 *= this._negLight;
              }
              ...
              if ((double) lightingState2.B2 < (double) num6)
              {
                ...
                {
                  if (lightingState1.HoneyLight)
                    num6 *= (float) ((double) this._honeyLightB * (double) fastRandom.Next(97, 100) * 0.0099999997764825821);
                  else
                    num6 *= (float) ((double) this._wetLightB * (double) fastRandom.Next(97, 100) * 0.0099999997764825821);
                }
                else
                  num6 *= this._negLight;
              }
              ...
              if ((double) jagged[index2 + num1].R2 <= (double) num4)
              {
                ...
                else if (lightingState.WetLight)
                {
                  ...
                  if (lightingState.HoneyLight)
                    num4 *= (float) ((double) this._honeyLightR * (double) fastRandom2.Next(98, 100) * 0.0099999997764825821);
                  else
                    num4 *= (float) ((double) this._wetLightR * (double) fastRandom2.Next(98, 100) * 0.0099999997764825821);
                }
                else
                  num4 *= this._negLight;
              }
