...
namespace Terraria.Audio
{
  public class SoundPlayer
  {
    ...
    {
      return Main.dedServ || style == null || !style.IsTrackable || (double) Vector2.DistanceSquared(Main.screenPosition + new Vector2((float) (Main.screenWidth / 2), (float) (Main.screenHeight / 2)), position) > 100000000.0 ? SlotId.Invalid : this._trackedSounds.Add(new ActiveSound(style, position));
    }
    ...
    {
      return Main.dedServ || style == null || !style.IsTrackable ? SlotId.Invalid : this._trackedSounds.Add(new ActiveSound(style));
    }
