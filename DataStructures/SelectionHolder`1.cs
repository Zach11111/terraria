...
namespace Terraria.DataStructures
{
  public abstract class SelectionHolder<TCycleType> where TCycleType : class, IConfigKeyHolder
  {
    ...
    {
      this.SetActiveFrame(this.Options.FirstOrDefault<KeyValuePair<string, TCycleType>>((Func<KeyValuePair<string, TCycleType>, bool>) (pair => pair.Key == frameName)).Value ?? this.Options.Values.First<TCycleType>());
    }
