...
namespace Terraria.DataStructures
{
  public static class PlayerDrawLayers
  {
    ...
    {
      drawinfo.Position.Y += (float) ((int) drawinfo.mountOffSet / 2);
    }
    ...
    {
      return drawinfo.drawPlayer.shoe == (sbyte) 15;
    }
...
label_37:
    ...
    {
      return new Vector2((float) (6 * (drawinfo.playerEffect.HasFlag((Enum) SpriteEffects.FlipHorizontally) ? -1 : 1)), (float) (2 * (drawinfo.playerEffect.HasFlag((Enum) SpriteEffects.FlipVertically) ? -1 : 1)));
    }

    private static Vector2 GetCompositeOffset_FrontArm(ref PlayerDrawSet drawinfo)
    {
      return new Vector2((float) (-5 * (drawinfo.playerEffect.HasFlag((Enum) SpriteEffects.FlipHorizontally) ? -1 : 1)), 0.0f);
    }
