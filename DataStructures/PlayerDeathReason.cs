...
namespace Terraria.DataStructures
{
  public class PlayerDeathReason
  {
    ...
    public int? SourceProjectileType
    {
      get
      {
        return this._sourceProjectileLocalIndex == -1 ? new int?() : new int?(this._sourceProjectileType);
      }
    }
    ...
    {
      return this._sourceCustomReason != null ? NetworkText.FromLiteral(this._sourceCustomReason) : Lang.CreateDeathMessage(deadPlayerName, this._sourcePlayerIndex, this._sourceNPCIndex, this._sourceProjectileLocalIndex, this._sourceOtherIndex, this._sourceProjectileType, this._sourceItemType);
    }
