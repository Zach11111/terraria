...
namespace Terraria.Social.Steam
{
  public class WorkshopSocialModule : Terraria.Social.Base.WorkshopSocialModule
  {
    ...
    {
      return this._downloader.WorldPaths.Select<string, string>((Func<string, string>) (folderPath => folderPath + Path.DirectorySeparatorChar.ToString() + "world.wld")).ToList<string>();
    }
