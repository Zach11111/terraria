...
namespace Terraria
{
  public class Netplay
  {
    ...
    {
      for (int nextOpenClientSlot = 0; nextOpenClientSlot < Main.maxNetPlayers; ++nextOpenClientSlot)
      {
        if (!Netplay.Clients[nextOpenClientSlot].IsConnected())
          return nextOpenClientSlot;
      }
      return -1;
    }
