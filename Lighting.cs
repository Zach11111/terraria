...
namespace Terraria
{
  public class Lighting
  {
    ...
    {
      get => Lighting.Mode != LightMode.Retro && Lighting.Mode != LightMode.Trippy;
    }
    ...
    {
      get => Main.LightingEveryFrame && !Main.RenderTargetsRequired && !Lighting.NotRetro;
    }
    ...
    {
      return Main.gameMenu ? Color.White : new Color(Lighting._activeEngine.GetColor(tileCoords.X, tileCoords.Y) * Lighting.GlobalBrightness);
    }

    public static Color GetColor(Point tileCoords, Color originalColor)
    {
      return Main.gameMenu ? originalColor : new Color(Lighting._activeEngine.GetColor(tileCoords.X, tileCoords.Y) * originalColor.ToVector3());
    }

    public static Color GetColor(int x, int y, Color oldColor)
    {
      return Main.gameMenu ? oldColor : new Color(Lighting._activeEngine.GetColor(x, y) * oldColor.ToVector3());
    }

    public static Color GetColorClamped(int x, int y, Color oldColor)
    {
      return Main.gameMenu ? oldColor : new Color(Vector3.Min(Vector3.One, Lighting._activeEngine.GetColor(x, y)) * oldColor.ToVector3());
    }
    ...
    public static void GetColor4Slice(int centerX, int centerY, ref Color[] slices)
    {
      ...
      if (num1 >= (double) num4)
      {
        int r = (int) ((double) byte.MaxValue * (double) color3.X * (double) Lighting.GlobalBrightness);
        int g = (int) ((double) byte.MaxValue * (double) color3.Y * (double) Lighting.GlobalBrightness);
        int b = (int) ((double) byte.MaxValue * (double) color3.Z * (double) Lighting.GlobalBrightness);
        ...
        if (b > (int) byte.MaxValue)
          b = (int) byte.MaxValue;
        slices[0] = new Color((int) (byte) r, (int) (byte) g, (int) (byte) b, (int) byte.MaxValue);
      }
      else
      {
        int r = (int) ((double) byte.MaxValue * (double) color1.X * (double) Lighting.GlobalBrightness);
        int g = (int) ((double) byte.MaxValue * (double) color1.Y * (double) Lighting.GlobalBrightness);
        int b = (int) ((double) byte.MaxValue * (double) color1.Z * (double) Lighting.GlobalBrightness);
        if (r > (int) byte.MaxValue)
          r = (int) byte.MaxValue;
        if (g > (int) byte.MaxValue)
          g = (int) byte.MaxValue;
      ...
      if (num1 >= (double) num3)
      {
        int r = (int) ((double) byte.MaxValue * (double) color4.X * (double) Lighting.GlobalBrightness);
        int g = (int) ((double) byte.MaxValue * (double) color4.Y * (double) Lighting.GlobalBrightness);
        int b = (int) ((double) byte.MaxValue * (double) color4.Z * (double) Lighting.GlobalBrightness);
        if (r > (int) byte.MaxValue)
          r = (int) byte.MaxValue;
        if (g > (int) byte.MaxValue)
          g = (int) byte.MaxValue;
        if (b > (int) byte.MaxValue)
          b = (int) byte.MaxValue;
        slices[1] = new Color((int) (byte) r, (int) (byte) g, (int) (byte) b, (int) byte.MaxValue);
      }
      else
      {
        int r = (int) ((double) byte.MaxValue * (double) color1.X * (double) Lighting.GlobalBrightness);
      ...
      if ((double) num2 >= (double) num4)
      {
        ...
        if (b > (int) byte.MaxValue)
          b = (int) byte.MaxValue;
        slices[2] = new Color((int) (byte) r, (int) (byte) g, (int) (byte) b, (int) byte.MaxValue);
      }
      else
      {
        int r = (int) ((double) byte.MaxValue * (double) color2.X * (double) Lighting.GlobalBrightness);
        int g = (int) ((double) byte.MaxValue * (double) color2.Y * (double) Lighting.GlobalBrightness);
        int b = (int) ((double) byte.MaxValue * (double) color2.Z * (double) Lighting.GlobalBrightness);
        if (r > (int) byte.MaxValue)
          r = (int) byte.MaxValue;
        if (g > (int) byte.MaxValue)
          g = (int) byte.MaxValue;
      ...
      if ((double) num2 >= (double) num3)
      {
        ...
        if (b > (int) byte.MaxValue)
          b = (int) byte.MaxValue;
        slices[3] = new Color((int) (byte) r, (int) (byte) g, (int) (byte) b, (int) byte.MaxValue);
      }
      else
      {
        int r = (int) ((double) byte.MaxValue * (double) color2.X * (double) Lighting.GlobalBrightness);
