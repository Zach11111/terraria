  ...
  public class Mount
  {
    ...
    public static void Initialize()
    {
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData1.backTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData2.backTextureExtra = Asset<Texture2D>.Empty;
        mountData2.frontTexture = Asset<Texture2D>.Empty;
        mountData2.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData3.backTextureExtra = Asset<Texture2D>.Empty;
        mountData3.frontTexture = Asset<Texture2D>.Empty;
        mountData3.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData4.backTextureExtra = Asset<Texture2D>.Empty;
        mountData4.frontTexture = Asset<Texture2D>.Empty;
        mountData4.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData5.backTexture = Asset<Texture2D>.Empty;
        mountData5.backTextureExtra = Asset<Texture2D>.Empty;
        mountData5.frontTexture = TextureAssets.MinecartMount;
        mountData5.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData6.backTexture = Asset<Texture2D>.Empty;
        mountData6.backTextureExtra = Asset<Texture2D>.Empty;
        mountData6.frontTexture = TextureAssets.FishMinecartMount;
        mountData6.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData7.backTextureExtra = Asset<Texture2D>.Empty;
        mountData7.frontTexture = Asset<Texture2D>.Empty;
        mountData7.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData8.frontTexture = Asset<Texture2D>.Empty;
        mountData8.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData9.backTexture = Asset<Texture2D>.Empty;
        mountData9.backTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData10.backTextureExtra = Asset<Texture2D>.Empty;
        mountData10.backTextureExtraGlow = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData11.backTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData12.backTextureExtra = Asset<Texture2D>.Empty;
        mountData12.frontTexture = Asset<Texture2D>.Empty;
        mountData12.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData13.backTexture = Asset<Texture2D>.Empty;
        mountData13.backTextureExtra = Asset<Texture2D>.Empty;
        mountData13.frontTexture = TextureAssets.MinecartMechMount[0];
        mountData13.frontTextureGlow = TextureAssets.MinecartMechMount[1];
        mountData13.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData14.frontTexture = Asset<Texture2D>.Empty;
        mountData14.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData15.backTexture = Asset<Texture2D>.Empty;
        mountData15.backTextureExtra = Asset<Texture2D>.Empty;
        mountData15.frontTexture = TextureAssets.MinecartWoodMount;
        mountData15.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData16.backTextureExtra = Asset<Texture2D>.Empty;
        mountData16.frontTexture = Asset<Texture2D>.Empty;
        mountData16.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData17.frontTexture = Asset<Texture2D>.Empty;
        mountData17.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData18.backTextureExtra = Asset<Texture2D>.Empty;
        mountData18.frontTexture = Asset<Texture2D>.Empty;
        mountData18.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData19.backTextureExtra = Asset<Texture2D>.Empty;
        mountData19.frontTexture = Asset<Texture2D>.Empty;
        mountData19.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData20.backTexture = Asset<Texture2D>.Empty;
        mountData20.backTextureExtra = Asset<Texture2D>.Empty;
        mountData20.frontTexture = TextureAssets.Extra[164];
        mountData20.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData21.backTexture = Asset<Texture2D>.Empty;
        mountData21.backTextureExtra = Asset<Texture2D>.Empty;
        mountData21.frontTexture = TextureAssets.Extra[166];
        mountData21.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData22.frontTexture = Asset<Texture2D>.Empty;
        mountData22.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        mountData23.backTexture = Asset<Texture2D>.Empty;
        mountData23.backTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData24.frontTexture = Asset<Texture2D>.Empty;
        mountData24.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData25.backTextureExtra = Asset<Texture2D>.Empty;
        mountData25.frontTexture = Asset<Texture2D>.Empty;
        mountData25.frontTextureExtra = Asset<Texture2D>.Empty;
      ...
      if (Main.netMode != 2)
      {
        ...
        mountData26.frontTexture = Asset<Texture2D>.Empty;
        mountData26.frontTextureExtra = Asset<Texture2D>.Empty;
    ...
    public int PlayerOffset
    {
      get
      {
        return !this._active || this._frame >= this._data.totalFrames ? 0 : this._data.playerYOffsets[this._frame];
      }
    }

    public int PlayerOffsetHitbox
    {
      get => !this._active ? 0 : -this.PlayerOffset + this._data.heightBoost;
    }
    ...
    {
      return MountType <= -1 || MountType >= MountID.Count ? 0 : Mount.mounts[MountType].heightBoost;
    }
    ...
    {
      get => this._shouldSuperCart ? Mount.SuperCartDashSpeed : this._data.dashSpeed;
    }

    public float Acceleration
    {
      get => this._shouldSuperCart ? Mount.SuperCartAcceleration : this._data.acceleration;
    }
    ...
    {
      get => this._data == null ? this._defaultDelegatesData : this._data.delegations;
    }
    ...
    {
      return (IEntitySource) new EntitySource_Mount((Entity) mountedPlayer, this.Type);
    }
    ...
    {
      get => this._type != 9 || this._abilityCooldown < this._data.abilityCooldown / 2;
    }
    ...
    public void UpdateDrill(Player mountedPlayer, bool controlUp, bool controlDown)
    {
      ...
      mountSpecificData.diodeRotation = (float) ((double) mountSpecificData.diodeRotation * 0.85000002384185791 + 0.15000000596046448 * (double) mountSpecificData.diodeRotationTarget);
    ...
    public bool Hover(Player mountedPlayer)
    {
      ...
      if (this._type == 7)
      {
        ...
        if ((double) num8 < -0.95)
          num8 = -0.95f;
        float num9 = (float) (0.78539818525314331 * (double) num8 / 2.0);
      ...
      else if (this._type == 8)
      {
        ...
        if ((double) num11 < -0.95)
          num11 = -0.95f;
        float num12 = (float) (0.78539818525314331 * (double) num11 / 2.0);
        mountedPlayer.fullRotation = num12;
        Mount.DrillMountData mountSpecificData = (Mount.DrillMountData) this._mountSpecificData;
        float num13 = mountSpecificData.outerRingRotation + mountedPlayer.velocity.X / 80f;
        if ((double) num13 > 3.1415927410125732)
          num13 -= 6.28318548f;
        else if ((double) num13 < -3.1415927410125732)
          num13 += 6.28318548f;
      ...
      else if (this._type == 23)
      {
        ...
        float num16 = -0.196349546f * num14 * (float) mountedPlayer.direction + 0.196349546f * num15;
    ...
    private float GetWitchBroomTrinketRotation(Player player)
    {
      ...
      if (WorldGen.InAPlaceWithWind(tileCoordinates.X, tileCoordinates.Y, 1, 1))
        num2 = 1f;
      float num3 = (float) (Math.Sin((double) player.miscCounter / 300.0 * 6.2831854820251465 * 3.0) * 0.78539818525314331 * (double) Math.Abs(Main.WindForVisuals) * 0.5 + 0.78539818525314331 * -(double) Main.WindForVisuals * 0.5) * num2;
    ...
    public void UpdateFrame(Player mountedPlayer, int state, Vector2 velocity)
    {
      ...
      switch (this._type)
      {
        ...
        case 8:
          if (state == 0 || state == 1)
          {
            ...
            if ((double) num6 != 0.0)
            {
              ...
              if ((double) mountedPlayer.fullRotation > 0.78539818525314331)
          ...
          if (state == 1)
          {
            ...
            if (((this._type == 10 ? 1 : (this._type == 47 ? 1 : 0)) & (flag2 ? 1 : 0)) != 0)
            {
              ...
              for (float num9 = 0.0f; (double) num9 < 14.0; ++num9)
              {
                ...
                Vector2 vector2_2 = Vector2.UnitY.RotatedBy((double) num9 * 6.2831854820251465 / 14.0 + (double) num8) * (0.2f * (float) this._frameExtra);
        ...
        case 14:
          ...
          float y = 12f;
          float num12 = 40f;
          mountedPlayer.basiliskCharge = num10 != 0 ? Utils.Clamp<float>(mountedPlayer.basiliskCharge + 0.00555555569f, 0.0f, 1f) : 0.0f;
        ...
        case 43:
          ...
          if (mountedPlayer.isPerformingPogostickTricks)
            mountedPlayer.fullRotation += (float) ((double) mountedPlayer.direction * 6.2831854820251465 / 30.0);
          else
            mountedPlayer.fullRotation = (float) ((double) Math.Sign(mountedPlayer.velocity.X) * (double) Utils.GetLerpValue(0.0f, this.RunSpeed - 0.2f, Math.Abs(mountedPlayer.velocity.X), true) * 0.40000000596046448);
        ...
        case 44:
          ...
          else if (!mountSpecificData1 & flag3)
          {
            ...
            float num13 = 6.28318548f * Main.rand.NextFloat();
            for (float num14 = 0.0f; (double) num14 < 20.0; ++num14)
            {
              Dust dust = Main.dust[Dust.NewDust(Position, 0, 0, 228)];
              Vector2 vector2_4 = Vector2.UnitY.RotatedBy((double) num14 * 6.2831854820251465 / 20.0 + (double) num13) * 0.8f;
          ...
          break;
        case 45:
          bool flag4 = (double) Math.Abs(velocity.X) > (double) this.DashSpeed * 0.89999997615814209;
          if (this._mountSpecificData == null)
            this._mountSpecificData = (object) false;
          ...
          else if (!mountSpecificData2 & flag4)
          {
            ...
            float num16 = 6.28318548f * Main.rand.NextFloat();
            for (float num17 = 0.0f; (double) num17 < 20.0; ++num17)
            {
              Dust dust = Main.dust[Dust.NewDust(Position, 0, 0, 6)];
              Vector2 vector2_6 = Vector2.UnitY.RotatedBy((double) num17 * 6.2831854820251465 / 20.0 + (double) num16) * 0.8f;
          ...
          if (flag4)
          {
            ...
            int x = 6;
            Dust dust = Main.dust[Dust.NewDust(mountedPlayer.Center - new Vector2((float) x, (float) (x - 12)), x * 2, x * 2, Type)];
        ...
        case 49:
          ...
          double num18 = (double) velocity.Length();
          float num19 = mountedPlayer.velocity.Y * 0.05f;
          if (mountedPlayer.direction < 0)
            num19 *= -1f;
          mountedPlayer.fullRotation = num19;
      ...
      switch (state)
      {
        case 0:
          ...
          if (this._data.idleFrameCount != 0 && this._idleTime >= this._idleTimeNext)
          {
            ...
            int num20 = (int) ((double) (this._idleTime - this._idleTimeNext) / (double) idleFrameDelay);
            int idleFrameCount = this._data.idleFrameCount;
            if (num20 >= idleFrameCount)
            {
        ...
        case 1:
          ...
          {
            case 6:
              num21 = this._flipDraw ? velocity.X : -velocity.X;
              break;
            case 9:
            case 46:
              num21 = !this._flipDraw ? Math.Abs(velocity.X) : -Math.Abs(velocity.X);
              break;
            case 13:
              num21 = this._flipDraw ? velocity.X : -velocity.X;
              break;
            case 44:
              num21 = Math.Max(1f, Math.Abs(velocity.X) * 0.25f);
              break;
            case 48:
              num21 = Math.Max(0.5f, velocity.Length() * 0.125f);
              break;
            case 50:
              num21 = Math.Abs(velocity.X) * 0.5f;
              break;
            default:
              num21 = Math.Abs(velocity.X);
              break;
          }
          this._frameCounter += num21;
          if ((double) num21 >= 0.0)
          {
        ...
        case 2:
          ...
          if (this._type != 23)
            break;
          float num22 = mountedPlayer.velocity.Length();
          if ((double) num22 < 1.0)
          {
            this._frame = 0;
            this._frameCounter = 0.0f;
        ...
        case 5:
          ...
          {
            case 6:
              num23 = this._flipDraw ? velocity.X : -velocity.X;
              break;
            case 9:
              num23 = !this._flipDraw ? Math.Abs(velocity.X) : -Math.Abs(velocity.X);
              break;
            case 13:
              num23 = this._flipDraw ? velocity.X : -velocity.X;
              break;
            default:
              num23 = Math.Abs(velocity.X);
              break;
          }
          this._frameCounter += num23;
          if ((double) num23 >= 0.0)
          {
    ...
    {
      return ((double) mountedPlayer.velocity.X == 0.0 ? 1 : (!mountedPlayer.slippy && !mountedPlayer.slippy2 && !mountedPlayer.windPushed || mountedPlayer.controlLeft ? 0 : (!mountedPlayer.controlRight ? 1 : 0))) != 0 ? 0 : 1;
    }
    ...
    private static void EmitGolfCartSmoke(Player mountedPlayer, bool rushing)
    {
      ...
      Dust dust = Dust.NewDustDirect(Position, 0, 0, 31, (float) -mountedPlayer.direction, (float) (-(double) mountedPlayer.gravDir * 0.23999999463558197), 100);
    ...
    public void UpdateEffects(Player mountedPlayer)
    {
      ...
      switch (this._type)
      {
          ...
          for (int index = 0; index < 200; ++index)
          {
            ...
            if (npc.CanBeChasedBy((object) this))
            {
              ...
              if ((double) num3 < (double) num2 && ((double) Vector2.Distance(mousePosition, center) > (double) num3 && (double) num3 < (double) num1 || !flag1))
              {
                ...
                if (mountedPlayer.direction == 1 && (double) num4 > 1.0471975949079879)
                  flag2 = false;
        ...
        case 22:
          ...
          break;
        case 23:
          Vector2 pos4 = mountedPlayer.Center + this.GetWitchBroomTrinketOriginOffset(mountedPlayer) + (this.GetWitchBroomTrinketRotation(mountedPlayer) + 1.57079637f).ToRotationVector2() * 11f;
    ...
    public bool AimAbility(Player mountedPlayer, Vector2 mousePosition)
    {
      ...
      switch (this._type)
      {
        case 8:
          ...
          float num1 = mountSpecificData.diodeRotation % 6.28318548f;
          if ((double) num1 < 0.0)
            num1 += 6.28318548f;
          if ((double) num1 < (double) rotation)
          {
            if ((double) rotation - (double) num1 > 3.1415927410125732)
              num1 += 6.28318548f;
          }
          else if ((double) num1 - (double) rotation > 3.1415927410125732)
            num1 -= 6.28318548f;
      ...
      float shadow)
    {
      ...
      switch (this._type)
      {
        case 11:
          if (drawType == 2)
          {
            color1 = Color.White with { A = (byte) 127 };
            break;
          }
          break;
        case 12:
        ...
        case 24:
          if (drawType == 2)
          {
            color1 = (Color.SkyBlue * 0.5f) with
            {
              A = (byte) 20
            };
            break;
        ...
        case 35:
          if (drawType == 2)
          {
            ...
            if (effect.HasFlag((Enum) SpriteEffects.FlipHorizontally))
              x *= -1;
            Vector2 vector2 = new Vector2((float) x, -26f);
      ...
      switch (this._type)
      {
        ...
        case 45:
          if (drawType != 0 || (double) shadow != 0.0)
            break;
          if ((double) Math.Abs(drawPlayer.velocity.X) > (double) this.DashSpeed * 0.89999997615814209)
          {
