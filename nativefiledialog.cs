...
public static class nativefiledialog
{
  ...
  {
    return nativefiledialog.UTF8_ToManaged(nativefiledialog.INTERNAL_NFD_GetError());
  }
  ...
  {
    return nativefiledialog.UTF8_ToManaged(nativefiledialog.INTERNAL_NFD_PathSet_GetPath(ref pathset, index));
  }
