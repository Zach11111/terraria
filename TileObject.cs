          ...
          if (anchorRight.tileCount != 0)
          {
            ...
            for (int index = 0; index < anchorRight.tileCount; ++index)
            {
              ...
              if (tileSafely1.nactive())
              {
                ...
                if (!flag7 && (anchorRight.type & AnchorType.Tree) == AnchorType.Tree && TileID.Sets.IsATreeTrunk[(int) tileSafely1.type])
                {
                  flag7 = true;
                  if (index == 0)
                  {
          ...
          if (anchorLeft.tileCount != 0)
          {
            ...
            for (int index = 0; index < anchorLeft.tileCount; ++index)
            {
              ...
              if (tileSafely4.nactive())
              {
                ...
                if (!flag8 && (anchorLeft.type & AnchorType.Tree) == AnchorType.Tree && TileID.Sets.IsATreeTrunk[(int) tileSafely4.type])
                {
                  flag8 = true;
                  if (index == 0)
                  {
