...
namespace Terraria.Localization
{
  public class LanguageManager
  {
    ...
    {
      return this._categoryGroupedKeys.ContainsKey(name) ? this._categoryGroupedKeys[name].Count : 0;
    }
    ...
    {
      return !this._localizedTexts.ContainsKey(key) ? new LocalizedText(key, key) : this._localizedTexts[key];
    }

    public string GetTextValue(string key)
    {
      return this._localizedTexts.ContainsKey(key) ? this._localizedTexts[key].Value : key;
    }

    public string GetTextValue(string key, object arg0)
    {
      return this._localizedTexts.ContainsKey(key) ? this._localizedTexts[key].Format(arg0) : key;
    }

    public string GetTextValue(string key, object arg0, object arg1)
    {
      return this._localizedTexts.ContainsKey(key) ? this._localizedTexts[key].Format(arg0, arg1) : key;
    }

    public string GetTextValue(string key, object arg0, object arg1, object arg2)
    {
      return this._localizedTexts.ContainsKey(key) ? this._localizedTexts[key].Format(arg0, arg1, arg2) : key;
    }

    public string GetTextValue(string key, params object[] args)
    {
      return this._localizedTexts.ContainsKey(key) ? this._localizedTexts[key].Format(args) : key;
    }
