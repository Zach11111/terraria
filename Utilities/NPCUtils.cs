...
namespace Terraria.Utilities
{
  public static class NPCUtils
  {
    ...
    public static class SearchFilters
    {
      ...
      {
        return npc.type != 211 && npc.type != 210 && npc.type != 222 && npc.CanBeChasedBy();
      }
    ...
    public struct TargetSearchResults
    {
      ...
      {
        get => this._nearestNPCIndex != -1 ? Main.npc[this._nearestNPCIndex] : (NPC) null;
      }
      ...
      {
        get => this._nearestTankIndex != -1 ? Main.player[this._nearestTankIndex] : (Player) null;
      }
