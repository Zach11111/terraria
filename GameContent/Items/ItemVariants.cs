...
namespace Terraria.GameContent.Items
{
  public static class ItemVariants
  {
    ...
    {
      return ItemVariants.GetVariants(itemId).SingleOrDefault<ItemVariants.VariantEntry>((Func<ItemVariants.VariantEntry, bool>) (v => v.Variant == variant));
    }
    ...
    public class VariantEntry
    {
      ...
      {
        get => (IEnumerable<ItemVariantCondition>) this._conditions;
      }
      ...
      {
        return this.Conditions.Any<ItemVariantCondition>((Func<ItemVariantCondition, bool>) (c => c.IsMet()));
      }
    }
  }
}
