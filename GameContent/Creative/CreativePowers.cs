...
namespace Terraria.GameContent.Creative
{
  public class CreativePowers
  {
    public abstract class APerPlayerTogglePower : ICreativePower, IOnPlayerJoining
    {
      ...
      {
        return this._perPlayerIsEnabled.IndexInRange<bool>(playerIndex) && this._perPlayerIsEnabled[playerIndex];
      }
      ...
      IPowerSubcategoryElement
    {
      ...
      {
        return Main.netMode == 1 && this._needsToCommitChange ? this._currentTargetValue : this._sliderCurrentValueCache;
      }
      ...
      IPowerSubcategoryElement
    {
      ...
      internal float GetSliderValue()
      {
        return Main.netMode == 1 && this._needsToCommitChange ? this._currentTargetValue : this.GetSliderValueInner();
      }
    ...
    public class ModifyTimeRate : CreativePowers.ASharedSliderPower, IPersistentPerWorldContent
    {
      ...
      {
        this.TargetTimeRate = (int) Math.Round((double) Utils.Remap(this._sliderCurrentValueCache, 0.0f, 1f, 1f, 24f));
      }
      ...
      IPersistentPerWorldContent
    {
      ...
      internal override void UpdateInfoFromSliderValueCache()
      {
        this.StrengthMultiplierToGiveNPCs = (double) this._sliderCurrentValueCache > 0.33000001311302185 ? Utils.Remap(this._sliderCurrentValueCache, 0.33f, 1f, 1f, 3f) : Utils.Remap(this._sliderCurrentValueCache, 0.0f, 0.33f, 0.5f, 1f);
        ...
        UIElement.MouseEvent clickEvent)
      {
        ...
        uiImage.HAlign = 1f;
        uiImage.VAlign = yAnchor;
        uiImage.Left = new StyleDimension(4f, 0.0f);
    ...
    public class FreezeTime : CreativePowers.ASharedTogglePower, IPersistentPerWorldContent
    {
      ...
      {
        button.Append((UIElement) CreativePowersHelper.GetIconImage(CreativePowersHelper.CreativePowerIconLocations.FreezeTime));
      }
      ...
      public void Load(BinaryReader reader, int gameVersionSaveWasMadeOn)
      {
        this.SetPowerInfo(reader.ReadBoolean());
      }
      ...
      IPersistentPerWorldContent
    {
      internal override void CustomizeButton(UIElement button)
      {
        button.Append((UIElement) CreativePowersHelper.GetIconImage(CreativePowersHelper.CreativePowerIconLocations.WindFreeze));
      }
    ...
    public class FreezeRainPower : CreativePowers.ASharedTogglePower, IPersistentPerWorldContent
    {
      internal override void CustomizeButton(UIElement button)
      {
        button.Append((UIElement) CreativePowersHelper.GetIconImage(CreativePowersHelper.CreativePowerIconLocations.RainFreeze));
      }
    ...
    public class StopBiomeSpreadPower : CreativePowers.ASharedTogglePower, IPersistentPerWorldContent
    {
      internal override void CustomizeButton(UIElement button)
      {
        button.Append((UIElement) CreativePowersHelper.GetIconImage(CreativePowersHelper.CreativePowerIconLocations.StopBiomeSpread));
      }
      ...
      IPersistentPerPlayerContent
    {
      ...
      {
        return (double) sliderValue < 0.5 ? Utils.Remap(sliderValue, 0.0f, 0.5f, 0.1f, 1f) : Utils.Remap(sliderValue, 0.5f, 1f, 1f, 10f);
      }
      ...
      public void ApplyLoadedDataToOutOfPlayerFields(Player player)
      {
        this.PushChangeAndSetSlider(player.savedPerPlayerFieldsThatArentInThePlayerClass.spawnRatePowerSliderValue);
      }
    }
  }
}
