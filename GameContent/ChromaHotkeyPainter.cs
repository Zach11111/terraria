...
namespace Terraria.GameContent
{
  public class ChromaHotkeyPainter
  {
    ...
    public bool PotionAlert => this._quickHealAlert != 0;
    ...
    {
      return this._reactiveKeys.FirstOrDefault<ChromaHotkeyPainter.ReactiveRGBKey>((Func<ChromaHotkeyPainter.ReactiveRGBKey, bool>) (x => x.XNAKey == keyTarget));
    }
    ...
    private class ReactiveRGBKey
    {
      ...
      public void Update()
      {
        this._rgbKey.SetSolid(Color.Lerp(this._color, Color.Black, (float) Utils.GetLerpValue(this._startTime.TotalSeconds, this._expireTime.TotalSeconds, Main.gameTimeCache.TotalGameTime.TotalSeconds, true)));
      }
