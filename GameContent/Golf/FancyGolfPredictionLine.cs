...
namespace Terraria.GameContent.Golf
{
  public class FancyGolfPredictionLine
  {
    ...
    {
      return (float) (0.20000000298023224 + (double) Utils.GetLerpValue(0.8f, 1f, (float) (Math.Cos((double) travelledLength / 50.0 + (double) this._time * -3.1415927410125732) * 0.5 + 0.5), true) * 0.15000000596046448);
    }
