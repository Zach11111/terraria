...
namespace Terraria.GameContent.Golf
{
  public class GolfState
  {
    ...
    {
      return this._lastHitGolfBall == null || !this._lastHitGolfBall.active || !ProjectileID.Sets.IsAGolfBall[this._lastHitGolfBall.type] || this._lastHitGolfBall.owner != Main.myPlayer || this._lastRecordedSwingCount != (int) this._lastHitGolfBall.ai[1] ? (Projectile) null : this._lastHitGolfBall;
    }
    ...
    {
      this._hitRecords[this.GetGolfBallId(golfBall)]?.RecordHit(golfBall.position);
    }
