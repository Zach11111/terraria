...
namespace Terraria.GameContent.UI.ResourceSets
{
  public class PlayerResourceSetsManager
  {
    ...
    {
      this.SetActiveFrame(this._sets.FirstOrDefault<KeyValuePair<string, IPlayerResourcesDisplaySet>>((Func<KeyValuePair<string, IPlayerResourcesDisplaySet>, bool>) (pair => pair.Key == name)).Value ?? this._sets.Values.First<IPlayerResourcesDisplaySet>());
    }
