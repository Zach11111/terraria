...
namespace Terraria.GameContent.UI.States
{
  public class UIBestiaryTest : UIState
  {
    ...
    {
      return Language.GetTextValueWith("BestiaryInfo.PercentCollected", (object) new
      {
    ...
    {
      return (double) percentile < (double) this.GetProgressPercent() ? new Color(51, 137, (int) byte.MaxValue) : new Color(35, 40, 83);
    }
    ...
    {
      this._infoSpace.FillInfoForEntry((BestiaryEntry) null, new ExtraBestiaryInfoPageInformation());
    }
