  ...
  public class UICreativePowersMenu : UIState
  {
    ...
    private void InitializePage()
    {
      ...
      this._container = new UIElement()
      {
        ...
        Height = new StyleDimension((float) (-pixels - num), 1f),
        Top = new StyleDimension((float) pixels, 0.0f)
      };
    ...
    private void SetupGamepadPoints(SpriteBatch spriteBatch)
    {
      ...
      {
        uiLinkPointArray3 = this._helper.CreateUILinkPointGrid(ref currentID, pointsByCategoryName5, this._infiniteItemsWindow.GetItemsPerLine(), uiLinkPoint, uiLinkPointArray1[0], (UILinkPoint) null, (UILinkPoint) null);
    ...
    private class MenuTree<TEnum> where TEnum : struct, IConvertible
    {
      ...
      {
        this.CurrentOption = defaultValue.ToInt32((IFormatProvider) null);
      }
    }
