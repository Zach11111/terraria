...
namespace Terraria.GameContent.UI.States
{
  public class UIWorldLoad : UIState
  {
    ...
    {
      return this._progress == null ? string.Format("{0:0.0%} - ... - {1:0.0%}", (object) 0, (object) 0) : string.Format("{0:0.0%} - " + this._progress.Message + " - {1:0.0%}", (object) this._progress.TotalProgress, (object) this._progress.Value);
    }
  }
}
