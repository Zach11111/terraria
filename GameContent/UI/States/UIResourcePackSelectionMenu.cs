...
namespace Terraria.GameContent.UI.States
{
  public class UIResourcePackSelectionMenu : UIState, IHaveBackButtonCommand
  {
    ...
    {
      this._sourceController.UseResourcePacks(new ResourcePackList(this._enabledPacksList.Select<UIElement, ResourcePack>((Func<UIElement, ResourcePack>) (uiPack => ((UIResourcePack) uiPack).ResourcePack))));
    }
