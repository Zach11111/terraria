    ...
    public class WiresRadial
    {
      ...
      private void LineUpdate()
      {
        ...
        else
        {
          ...
          if ((double) Math.Abs(this._lineOpacity - num) >= 0.05000000074505806)
            return;
          ...
          if (toolAllowActuators || index != 5)
          {
            ...
            switch (index)
            {
              ...
              case 3:
                ...
                if (index == 3)
                  num6 = 0.0f;
                vector2_2 = position + Vector2.UnitX.RotatedBy((double) num6 * 6.2831854820251465 / (double) num4 - 3.1415927410125732 / (double) num5) * 45f;
                break;
              case 4:
                flag2 = false;
                vector2_2 = position;
                break;
              case 5:
                vector2_2 = position + Vector2.UnitX.RotatedBy((double) (index - 1) * 6.2831854820251465 / (double) num4 - 3.1415927410125732 / (double) num5) * 45f;
                break;
            }
            bool flag3 = false;
            if (index == 4)
            ...
            switch (index)
            {
              ...
              case 3:
              case 5:
                float num7 = (vector2_2 - position).ToRotation().AngleTowards(rotation, (float) (6.2831854820251465 / ((double) num4 * 2.0))) - rotation;
                if ((double) num3 >= 20.0 && (double) Math.Abs(num7) < 0.0099999997764825821)
                {
                  flag3 = true;
                  break;
                }
