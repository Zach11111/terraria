...
// Type: Terraria.GameContent.UI.Minimap.MinimapFrame
...
namespace Terraria.GameContent.UI.Minimap
{
  public class MinimapFrame : IConfigKeyHolder
  {
    ...
    {
      this._resetButton = new MinimapFrame.Button(hoverTexture, position, (Action) (() => this.ResetZoom()));
    }
    ...
    {
      this._zoomInButton = new MinimapFrame.Button(hoverTexture, position, (Action) (() => this.ZoomInButton()));
    }
    ...
    private class Button
    {
      ...
      {
        get => new Vector2((float) this._hoverTexture.Width(), (float) this._hoverTexture.Height());
      }
