...
namespace Terraria.GameContent.UI.Elements
{
  public class UIWorkshopPublishResourcePackListItem : UIPanel
  {
    ...
    {
      return obj is UIWorkshopPublishResourcePackListItem resourcePackListItem ? this._orderInList.CompareTo(resourcePackListItem._orderInList) : base.CompareTo(obj);
    }
