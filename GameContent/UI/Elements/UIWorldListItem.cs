...
namespace Terraria.GameContent.UI.Elements
{
  public class UIWorldListItem : AWorldListItem
  {
    ...
    {
      this._buttonLabel.SetText(Language.GetTextValue("UI.CopySeed", (object) this._data.GetFullSeedText(true)));
    }
    ...
    {
      return obj is UIWorldListItem uiWorldListItem ? this._orderInList.CompareTo(uiWorldListItem._orderInList) : base.CompareTo(obj);
    }
