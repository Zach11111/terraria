...
namespace Terraria.GameContent.Generation
{
  public class TrackGenerator
  {
    ...
    private TrackGenerator.TrackPlacementState CreateTunnel()
    {
      ...
      int num = 10;
      TrackGenerator.TrackPlacementState tunnel = TrackGenerator.TrackPlacementState.Invalid;
      ...
      for (TrackGenerator.TrackSlope trackSlope2 = TrackGenerator.TrackSlope.Up; trackSlope2 <= TrackGenerator.TrackSlope.Down; ++trackSlope2)
      {
        ...
        {
          trackPlacementState = TrackGenerator.CalculateStateForLocation(x + index * this._xDirection, y + index * (int) trackSlope2);
          switch (trackPlacementState)
          {
            ...
            default:
              ...
              num = index;
              tunnel = trackPlacementState;
              goto label_6;
          }
        }
label_6:
        if (tunnel != TrackGenerator.TrackPlacementState.Available && trackPlacementState == TrackGenerator.TrackPlacementState.Obstructed && (tunnel != TrackGenerator.TrackPlacementState.Obstructed || trackSlope1 != TrackGenerator.TrackSlope.Straight))
        {
          trackSlope1 = trackSlope2;
          num = 10;
          tunnel = trackPlacementState;
    ...
    private TrackGenerator.TrackPlacementState GetHistorySegmentPlacementState(
      ...
      int length)
    {
      TrackGenerator.TrackPlacementState segmentPlacementState = TrackGenerator.TrackPlacementState.Available;
      for (int index = startIndex; index < startIndex + length; ++index)
      {
        ...
        switch (stateForLocation)
        {
          case TrackGenerator.TrackPlacementState.Obstructed:
            ...
            {
              segmentPlacementState = stateForLocation;
              break;
            }
            break;
          case TrackGenerator.TrackPlacementState.Invalid:
    ...
    {
      return Main.tile[x, y].active() && Main.tile[x, y].type == (ushort) 314;
    }
