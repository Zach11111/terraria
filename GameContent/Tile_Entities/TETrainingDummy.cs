...
namespace Terraria.GameContent.Tile_Entities
{
  public class TETrainingDummy : TileEntity
  {
    ...
    {
      return Main.tile[x, y].active() && Main.tile[x, y].type == (ushort) 378 && Main.tile[x, y].frameY == (short) 0 && (int) Main.tile[x, y].frameX % 36 == 0;
    }
    ...
    {
      int index = NPC.NewNPC((IEntitySource) new EntitySource_TileEntity((TileEntity) this), (int) this.Position.X * 16 + 16, (int) this.Position.Y * 16 + 48, 488, 100);
    ...
    {
      return this.Position.X.ToString() + "x  " + (object) this.Position.Y + "y npc: " + (object) this.npc;
    }
  }
}
