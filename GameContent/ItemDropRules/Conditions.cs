...
namespace Terraria.GameContent.ItemDropRules
{
  public class Conditions
  {
    ...
    public class IsUsingSpecificAIValues : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      ...
      {
        return (double) info.npc.ai[this.aiSlotToCheck] == (double) this.valueToMatch;
      }
    ...
    public class FromCertainWaveAndAbove : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      ...
      public string GetConditionDescription()
      {
        return Language.GetTextValue("Bestiary_ItemDropConditions.PastWaveBasedDrop", (object) this.neededWave);
      }
    }
    ...
    public class IsExpert : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      ...
      public string GetConditionDescription()
      {
        return Main.masterMode ? Language.GetTextValue("Bestiary_ItemDropConditions.IsMasterMode") : Language.GetTextValue("Bestiary_ItemDropConditions.IsExpert");
      }
    }
    ...
    public class HalloweenGoodieBagDrop : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return Main.halloween && info.npc.lifeMax > 1 && info.npc.damage > 0 && !info.npc.friendly && info.npc.type != 121 && info.npc.type != 23 && (double) info.npc.value > 0.0 && !info.IsInSimulation;
      }
    ...
    public class HallowKeyCondition : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return (double) info.npc.value > 0.0 && Main.hardMode && !info.IsInSimulation && info.player.ZoneHallow;
      }
    ...
    public class JungleKeyCondition : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return (double) info.npc.value > 0.0 && Main.hardMode && !info.IsInSimulation && info.player.ZoneJungle;
      }
    ...
    public class CorruptKeyCondition : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return (double) info.npc.value > 0.0 && Main.hardMode && !info.IsInSimulation && info.player.ZoneCorrupt;
      }
    ...
    public class CrimsonKeyCondition : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return (double) info.npc.value > 0.0 && Main.hardMode && !info.IsInSimulation && info.player.ZoneCrimson;
      }
    ...
    public class FrozenKeyCondition : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return (double) info.npc.value > 0.0 && Main.hardMode && !info.IsInSimulation && info.player.ZoneSnow;
      }
    ...
    public class YoyoCascade : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return !Main.hardMode && info.npc.HasPlayerTarget && info.npc.lifeMax > 5 && !info.npc.friendly && (double) info.npc.value > 0.0 && (double) info.npc.position.Y / 16.0 > (double) (Main.maxTilesY - 350) && NPC.downedBoss3 && !info.IsInSimulation;
      }
    ...
    public class YoyosAmarok : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return Main.hardMode && info.npc.HasPlayerTarget && info.player.ZoneSnow && info.npc.lifeMax > 5 && !info.npc.friendly && (double) info.npc.value > 0.0 && !info.IsInSimulation;
      }
    ...
    public class YoyosYelets : IItemDropRuleCondition, IProvideItemConditionDescription
    {
      public bool CanDrop(DropAttemptInfo info)
      {
        return Main.hardMode && info.player.ZoneJungle && NPC.downedMechBossAny && info.npc.lifeMax > 5 && info.npc.HasPlayerTarget && !info.npc.friendly && (double) info.npc.value > 0.0 && !info.IsInSimulation;
      }
