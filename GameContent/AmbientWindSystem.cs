  ...
  public class AmbientWindSystem
  {
    ...
    private void SpawnAirborneCloud(int x, int y)
    {
      ...
      for (int index = 0; index < num1; ++index)
      {
        ...
        float radians = num6 + num5;
        Vector2 vector2_3 = Vector2.UnitX.RotatedBy((double) radians) * num7;
    ...
    private void SpawnFloorCloud(int x, int y)
    {
      ...
      if ((double) num1 < 4.0)
        Type = 1090;
      float num2 = 0.4f;
      float Scale = (float) (0.800000011920929 + (double) this._random.NextFloat() * 0.20000000298023224);
