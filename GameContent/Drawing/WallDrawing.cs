...
namespace Terraria.GameContent.Drawing
{
  public class WallDrawing
  {
    ...
    public void DrawWalls()
    {
      ...
      stopwatch.Start();
      int num2;
      int num3 = (int) ((double) (num2 = (int) (120.0 * (1.0 - (double) gfxQuality) + 40.0 * (double) gfxQuality)) * 0.40000000596046448);
      int num4 = (int) ((double) num2 * 0.34999999403953552);
      int num5 = (int) ((double) num2 * 0.30000001192092896);
    ...
    {
      Texture2D tileDrawTexture = TextureAssets.Wall[(int) tile.wall].Value;
