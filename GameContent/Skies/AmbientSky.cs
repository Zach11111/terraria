...
namespace Terraria.GameContent.Skies
{
  public class AmbientSky : CustomSky
  {
    ...
    public override void Update(GameTime gameTime)
    {
      ...
      {
        AmbientSky.SkyEntity skyEntity = entity.Value;
        skyEntity.Update(this._frameCounter);
        if (!skyEntity.IsActive)
        {
    ...
    public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
    {
      ...
      foreach (SlotVector<AmbientSky.SkyEntity>.ItemPair entity in (IEnumerable<SlotVector<AmbientSky.SkyEntity>.ItemPair>) this._entities)
        entity.Value.Draw(spriteBatch, 3f, minDepth, maxDepth);
    }
    ...
    private abstract class SkyEntity
    {
      ...
      {
        this.Frame.CurrentRow = (byte) (((uint) this.Frame.CurrentRow + 1U) % (uint) this.Frame.RowCount);
      }
    ...
    private class FadingSkyEntity : AmbientSky.SkyEntity
    {
      ...
      {
        int t = frameCount - this.TimeEntitySpawnedIn;
        if ((double) t >= (double) this.LifeTime * (double) this.OpacityNormalizedTimeToFadeOut)
          this.Opacity = Utils.GetLerpValue((float) this.LifeTime, (float) this.LifeTime * this.OpacityNormalizedTimeToFadeOut, (float) t, true);
        else
          this.Opacity = Utils.GetLerpValue(0.0f, (float) this.LifeTime * this.OpacityNormalizedTimeToFadeIn, (float) t, true);
      }
      ...
      {
        return Color.Lerp(backgroundColor, Color.White, this.BrightnessLerper) * this.Opacity * this.FinalOpacityMultiplier * this.Helper_GetOpacityWithAccountingForOceanWaterLine();
      }
    ...
    private class ButterfliesSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      {
        this.Velocity = new Vector2((float) ((0.10000000149011612 + (double) Math.Abs(Main.WindForVisuals) * 0.05000000074505806) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class LostKiteSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public override void UpdateVelocity(int frameCount)
      {
        float num = (float) (1.2000000476837158 + (double) Math.Abs(Main.WindForVisuals) * 3.0);
    ...
    private class PegasusSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this.Velocity = new Vector2((float) ((1.5 + (double) Math.Abs(Main.WindForVisuals) * 0.60000002384185791) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class VultureSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this.Velocity = new Vector2((float) ((3.0 + (double) Math.Abs(Main.WindForVisuals) * 0.800000011920929) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class PixiePosseSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this.Velocity = new Vector2((float) ((0.11999999731779099 + (double) Math.Abs(Main.WindForVisuals) * 0.079999998211860657) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class SeagullsGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public static List<AmbientSky.SeagullsGroupSkyEntity> CreateGroup(
        ...
        FastRandom random)
      {
        List<AmbientSky.SeagullsGroupSkyEntity> group = new List<AmbientSky.SeagullsGroupSkyEntity>();
        int num1 = 100;
        ...
        for (int index = 0; index < num2; ++index)
        {
          ...
          seagullsGroupSkyEntity.SetMagnetization(vector2_2 * (float) ((double) random.NextFloat() * 0.30000001192092896 + 0.85000002384185791) * 0.05f, targetOffset);
          group.Add(seagullsGroupSkyEntity);
        }
        return group;
      }
    }
    ...
    private class GastropodGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this._velocityVsMagnet += this._magnetAccelerations * new Vector2((float) Math.Sign(this._magnetPointTarget.X - this._positionVsMagnet.X), (float) Math.Sign(this._magnetPointTarget.Y - this._positionVsMagnet.Y));
        this._positionVsMagnet += this._velocityVsMagnet;
        this.Velocity = new Vector2((float) ((1.5 + (double) Math.Abs(Main.WindForVisuals) * 0.20000000298023224) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f) + this._velocityVsMagnet;
      ...
      public static List<AmbientSky.GastropodGroupSkyEntity> CreateGroup(
        ...
        FastRandom random)
      {
        List<AmbientSky.GastropodGroupSkyEntity> group = new List<AmbientSky.GastropodGroupSkyEntity>();
        int num1 = 100;
        ...
        Vector2 vector2_2 = new Vector2((float) ((double) random.NextFloat() * 0.10000000149011612 + 0.10000000149011612), (float) ((double) random.NextFloat() * 0.30000001192092896 + 0.30000001192092896));
        ...
        for (int index = 0; index < num2; ++index)
        {
          ...
          group.Add(gastropodGroupSkyEntity);
        }
        return group;
      }
    }
    ...
    private class SlimeBalloonGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public static List<AmbientSky.SlimeBalloonGroupSkyEntity> CreateGroup(
        ...
        FastRandom random)
      {
        List<AmbientSky.SlimeBalloonGroupSkyEntity> group = new List<AmbientSky.SlimeBalloonGroupSkyEntity>();
        int num1 = 100;
        ...
        Vector2 vector2_2 = new Vector2((float) ((double) random.NextFloat() * 0.10000000149011612 + 0.10000000149011612), (float) ((double) random.NextFloat() * 0.10000000149011612 + 0.10000000149011612));
        ...
        for (int index = 0; index < num2; ++index)
        {
          ...
          group.Add(balloonGroupSkyEntity);
        }
        return group;
      }
    }
    ...
    private class HellBatsGoupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public static List<AmbientSky.HellBatsGoupSkyEntity> CreateGroup(
        ...
        FastRandom random)
      {
        List<AmbientSky.HellBatsGoupSkyEntity> group = new List<AmbientSky.HellBatsGoupSkyEntity>();
        int num1 = 100;
        ...
        for (int index = 0; index < num2; ++index)
        {
          ...
          batsGoupSkyEntity.SetMagnetization(vector2_2 * (float) ((double) random.NextFloat() * 0.30000001192092896 + 0.85000002384185791) * 0.05f, targetOffset);
          group.Add(batsGoupSkyEntity);
        }
        return group;
      }
      ...
      {
        return Main.netMode == 2 || Main.BackgroundEnabled ? 1f : 0.0f;
      }
    }
    ...
    private class BatsGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public static List<AmbientSky.BatsGroupSkyEntity> CreateGroup(
        ...
        FastRandom random)
      {
        List<AmbientSky.BatsGroupSkyEntity> group = new List<AmbientSky.BatsGroupSkyEntity>();
        int num1 = 100;
        int num2 = random.Next(20, 40);
        VirtualCamera virtualCamera = new VirtualCamera(player);
        SpriteEffects spriteEffects = (double) Main.WindForVisuals > 0.0 ? SpriteEffects.None : SpriteEffects.FlipHorizontally;
        ...
        for (int index = 0; index < num2; ++index)
        {
          ...
          batsGroupSkyEntity.SetMagnetization(vector2_2 * (float) ((double) random.NextFloat() * 0.30000001192092896 + 0.85000002384185791) * 0.05f, targetOffset);
          group.Add(batsGroupSkyEntity);
        }
        return group;
      }
    }
    ...
    private class AirshipSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this.Velocity = new Vector2((float) ((6.0 + (double) Math.Abs(Main.WindForVisuals) * 1.6000000238418579) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class EOCSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      {
        this.Velocity = new Vector2((float) (this._direction * 3), (float) Math.Cos((double) frameCount / 1200.0 * 6.2831854820251465) * this._waviness);
      }
    ...
    private class MeteorSkyEntity : AmbientSky.FadingSkyEntity
    {
      public MeteorSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Frame = new SpriteFrame((byte) 1, (byte) 4);
        Vector2 rotationVector2 = ((float) (0.78539818525314331 + (double) random.NextFloat() * 1.5707963705062866)).ToRotationVector2();
