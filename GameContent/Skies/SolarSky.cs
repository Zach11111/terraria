  ...
  public class SolarSky : CustomSky
  {
    ...
    public override void Activate(Vector2 position, params object[] args)
    {
      ...
      for (int index = 0; index < this._meteors.Length; ++index)
      {
        ...
        this._meteors[index].Depth = this._random.Next(3) == 0 ? (float) ((double) this._random.NextFloat() * 5.0 + 4.8000001907348633) : (float) ((double) this._random.NextFloat() * 3.0 + 1.7999999523162842);
