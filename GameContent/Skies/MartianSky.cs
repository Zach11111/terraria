  ...
  public class MartianSky : CustomSky
  {
    ...
    private void GenerateUfos()
    {
      ...
      for (int index = 0; index < num1; ++index)
      {
        ...
        this._ufos[index] = new MartianSky.Ufo(TextureAssets.Extra[5].Value, (float) (Main.rand.NextDouble() * 4.0 + 6.5999999046325684));
      ...
      for (int index = num1; index < this._ufos.Length; ++index)
      {
        ...
        this._ufos[index] = new MartianSky.Ufo(TextureAssets.Extra[6].Value, (float) (Main.rand.NextDouble() * 5.0 + 1.6000000238418579));
