...
namespace Terraria.GameContent.Skies
{
  public class PartySky : CustomSky
  {
    ...
    {
      this._balloons[i].Depth = (float) ((double) i / (double) this._balloons.Length * 1.75 + 1.6000000238418579);
    ...
    {
      return (double) Main.player[Main.myPlayer].townNPCs > 0.0 || Main.SceneMetrics.PartyMonolithCount > 0;
    }
