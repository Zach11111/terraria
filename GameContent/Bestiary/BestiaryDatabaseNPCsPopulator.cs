...
namespace Terraria.GameContent.Bestiary
{
  public class BestiaryDatabaseNPCsPopulator
  {
    ...
    private void TryGivingEntryFlavorTextIfItIsMissing(BestiaryEntry entry)
    {
      ...
      {
        if (bestiaryInfoElement2 is BestiaryPortraitBackgroundProviderPreferenceInfoElement preferenceInfoElement && preferenceInfoElement.GetPreferredProvider() is SpawnConditionBestiaryInfoElement preferredProvider)
        {
    ...
    {
      this.Register(BestiaryEntry.Enemy(85)).Icon = (IEntryIcon) new UnlockableNPCEntryIcon(85, ai3: 3f);
    }
    ...
    {
      this.FindEntryByNPCID(121).Info.AddRange((IEnumerable<IBestiaryInfoElement>) this.FindEntryByNPCID(81).Info.OfType<ItemDropBestiaryInfoElement>());
    }
