...
namespace Terraria.GameContent.Bestiary
{
    ...
    IBestiaryInfoElement
  {
    ...
    {
      return info.UnlockState == BestiaryEntryUnlockState.NotKnownAtAll_0 ? (string) null : Language.GetText(this._key).Value;
    }
    ...
    {
      button.OnUpdate += (UIElement.ElementEvent) (e => this.ShowButtonName(e));
    }
