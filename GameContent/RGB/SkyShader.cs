...
namespace Terraria.GameContent.RGB
{
  public class SkyShader : ChromaShader
  {
    ...
    {
      this._backgroundTransition = MathHelper.Clamp((float) (((double) (Main.player[Main.myPlayer].position.Y / 16f) - Main.worldSurface * 0.25) / (Main.worldSurface * 0.10000000149011612)), 0.0f, 1f);
