...
namespace Terraria.GameContent.RGB
{
  public class MartianMadnessShader : ChromaShader
  {
      ...
      float time)
    {
      ...
      {
        float num1 = (float) ((double) time * 0.5 % 6.2831854820251465);
        if ((double) num1 > 3.1415927410125732)
          num1 = 6.28318548f - num1;
        Vector2 vector2_1 = new Vector2((float) (1.7000000476837158 + Math.Cos((double) num1) * 2.0), (float) (Math.Sin((double) num1) * 1.1000000238418579 - 0.5));
        for (int index = 0; index < fragment.Count; ++index)
        {
          Vector2 canvasPositionOfIndex = fragment.GetCanvasPositionOfIndex(index);
          Vector4 vector4 = this._backgroundColor;
          float num2 = Math.Abs(vector2_1.X - canvasPositionOfIndex.X);
          if ((double) canvasPositionOfIndex.Y > (double) vector2_1.Y && (double) num2 < 0.20000000298023224)
          {
            float num3 = 1f - MathHelper.Clamp((float) (((double) num2 - 0.20000000298023224 + 0.20000000298023224) / 0.20000000298023224), 0.0f, 1f);
            float num4 = Math.Max(0.0f, (float) (1.0 - (double) Math.Abs((float) (((double) num1 - 1.5707963705062866) / 1.5707963705062866)) * 3.0));
          ...
          if ((double) num5 < 1.0)
          {
            float amount = 1f - MathHelper.Clamp((float) (((double) num5 - 1.0 + 0.20000000298023224) / 0.20000000298023224), 0.0f, 1f);
          ...
          if ((double) num6 < 1.0)
          {
            float amount = 1f - MathHelper.Clamp((float) (((double) num6 - 1.0 + 0.20000000298023224) / 0.20000000298023224), 0.0f, 1f);
