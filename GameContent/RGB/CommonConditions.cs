...
namespace Terraria.GameContent.RGB
{
  public static class CommonConditions
  {
    ...
    {
      public static readonly ChromaCondition Sky = (ChromaCondition) new CommonConditions.SimpleCondition((Func<Player, bool>) (player => (double) player.position.Y / 16.0 < Main.worldSurface * 0.44999998807907104));
      public static readonly ChromaCondition Surface = (ChromaCondition) new CommonConditions.SimpleCondition((Func<Player, bool>) (player => player.ZoneOverworldHeight && (double) player.position.Y / 16.0 >= Main.worldSurface * 0.44999998807907104 && !CommonConditions.Depth.IsPlayerInFrontOfDirtWall(player)));
      public static readonly ChromaCondition Vines = (ChromaCondition) new CommonConditions.SimpleCondition((Func<Player, bool>) (player => player.ZoneOverworldHeight && (double) player.position.Y / 16.0 >= Main.worldSurface * 0.44999998807907104 && CommonConditions.Depth.IsPlayerInFrontOfDirtWall(player)));
