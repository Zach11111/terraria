  ...
  public class TilePaintSystemV2
  {
    ...
    public abstract class ARenderTargetHolder
    {
      ...
      protected void PrepareTextureIfNecessary(Texture2D originalTexture, Rectangle? sourceRect = null)
      {
        ...
        this.PrepareShader();
        Rectangle destinationRectangle = sourceRect.Value with
        {
          X = 0,
          Y = 0
        };
    ...
    public class TreeTopRenderTargetHolder : TilePaintSystemV2.ARenderTargetHolder
    {
      ...
      {
        this.PrepareTextureIfNecessary(Main.Assets.Request<Texture2D>(TextureAssets.TreeTop[this.Key.TextureIndex].Name, (AssetRequestMode) 1).Value);
      }

      public override void PrepareShader()
      {
        this.PrepareShader(this.Key.PaintColor, TreePaintSystemData.GetTreeFoliageSettings(this.Key.TextureIndex, this.Key.TextureStyle));
      }
    }
    ...
    public class TreeBranchTargetHolder : TilePaintSystemV2.ARenderTargetHolder
    {
      ...
      public override void Prepare()
      {
        this.PrepareTextureIfNecessary(Main.Assets.Request<Texture2D>(TextureAssets.TreeBranch[this.Key.TextureIndex].Name, (AssetRequestMode) 1).Value);
      }
    ...
    public class TileRenderTargetHolder : TilePaintSystemV2.ARenderTargetHolder
    {
      ...
      public override void Prepare()
      {
        this.PrepareTextureIfNecessary(Main.Assets.Request<Texture2D>(TextureAssets.Tile[this.Key.TileType].Name, (AssetRequestMode) 1).Value);
      }

      public override void PrepareShader()
      {
        this.PrepareShader(this.Key.PaintColor, TreePaintSystemData.GetTileSettings(this.Key.TileType, this.Key.TileStyle));
      }
    }
    ...
    public class WallRenderTargetHolder : TilePaintSystemV2.ARenderTargetHolder
    {
      ...
      public override void Prepare()
      {
        this.PrepareTextureIfNecessary(Main.Assets.Request<Texture2D>(TextureAssets.Wall[this.Key.WallType].Name, (AssetRequestMode) 1).Value);
      }

      public override void PrepareShader()
      {
        this.PrepareShader(this.Key.PaintColor, TreePaintSystemData.GetWallSettings(this.Key.WallType));
      }
    }
    ...
    public struct TileVariationkey
    {
      ...
      {
        return obj is TilePaintSystemV2.TileVariationkey other && this.Equals(other);
      }
    ...
    public struct WallVariationKey
    {
      ...
      public override bool Equals(object obj)
      {
        return obj is TilePaintSystemV2.WallVariationKey other && this.Equals(other);
      }
    ...
    public struct TreeFoliageVariantKey
    {
      ...
      public override bool Equals(object obj)
      {
        return obj is TilePaintSystemV2.TreeFoliageVariantKey other && this.Equals(other);
      }
