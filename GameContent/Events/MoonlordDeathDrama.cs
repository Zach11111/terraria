...
namespace Terraria.GameContent.Events
{
  public class MoonlordDeathDrama
  {
    ...
    public static void Update()
    {
      ...
      {
        if ((double) Math.Abs(MoonlordDeathDrama.requestedLight - MoonlordDeathDrama.whitening) < 0.019999999552965164)
    ...
    public static void ThrowPieces(Vector2 MoonlordCoreCenter, int DramaSeed)
    {
      ...
      Vector2 vector2_1 = Vector2.UnitY.RotatedBy((double) r.NextFloat() * 1.5707963705062866 - 0.78539818525314331 + 3.1415927410125732);
      MoonlordDeathDrama._pieces.Add(new MoonlordDeathDrama.MoonlordPiece(Main.Assets.Request<Texture2D>("Images/Misc/MoonExplosion/Spine", (AssetRequestMode) 1).Value, new Vector2(64f, 150f), MoonlordCoreCenter + new Vector2(0.0f, 50f), vector2_1 * 6f, 0.0f, (float) ((double) r.NextFloat() * 0.10000000149011612 - 0.05000000074505806)));
      Vector2 vector2_2 = Vector2.UnitY.RotatedBy((double) r.NextFloat() * 1.5707963705062866 - 0.78539818525314331 + 3.1415927410125732);
      MoonlordDeathDrama._pieces.Add(new MoonlordDeathDrama.MoonlordPiece(Main.Assets.Request<Texture2D>("Images/Misc/MoonExplosion/Shoulder", (AssetRequestMode) 1).Value, new Vector2(40f, 120f), MoonlordCoreCenter + new Vector2(50f, -120f), vector2_2 * 10f, 0.0f, (float) ((double) r.NextFloat() * 0.10000000149011612 - 0.05000000074505806)));
      Vector2 vector2_3 = Vector2.UnitY.RotatedBy((double) r.NextFloat() * 1.5707963705062866 - 0.78539818525314331 + 3.1415927410125732);
      MoonlordDeathDrama._pieces.Add(new MoonlordDeathDrama.MoonlordPiece(Main.Assets.Request<Texture2D>("Images/Misc/MoonExplosion/Torso", (AssetRequestMode) 1).Value, new Vector2(192f, 252f), MoonlordCoreCenter, vector2_3 * 8f, 0.0f, (float) ((double) r.NextFloat() * 0.10000000149011612 - 0.05000000074505806)));
      Vector2 vector2_4 = Vector2.UnitY.RotatedBy((double) r.NextFloat() * 1.5707963705062866 - 0.78539818525314331 + 3.1415927410125732);
      MoonlordDeathDrama._pieces.Add(new MoonlordDeathDrama.MoonlordPiece(Main.Assets.Request<Texture2D>("Images/Misc/MoonExplosion/Head", (AssetRequestMode) 1).Value, new Vector2(138f, 185f), MoonlordCoreCenter - new Vector2(0.0f, 200f), vector2_4 * 12f, 0.0f, (float) ((double) r.NextFloat() * 0.10000000149011612 - 0.05000000074505806)));
    }

    public static void AddExplosion(Vector2 spot)
    {
      MoonlordDeathDrama._explosions.Add(new MoonlordDeathDrama.MoonlordExplosion(Main.Assets.Request<Texture2D>("Images/Misc/MoonExplosion/Explosion", (AssetRequestMode) 1).Value, spot, Main.rand.Next(2, 4)));
    }
    ...
    public class MoonlordPiece
    {
      ...
      public bool Dead
      {
        get
        {
          return (double) this._position.Y > (double) (Main.maxTilesY * 16) - 480.0 || (double) this._position.X < 480.0 || (double) this._position.X >= (double) (Main.maxTilesX * 16) - 480.0;
        }
      }
    ...
    public class MoonlordExplosion
    {
      ...
      public bool Dead
      {
        get
        {
          return (double) this._position.Y > (double) (Main.maxTilesY * 16) - 480.0 || (double) this._position.X < 480.0 || (double) this._position.X >= (double) (Main.maxTilesX * 16) - 480.0 || this._frameCounter >= this._frameSpeed * 7;
        }
      }
