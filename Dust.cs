...
namespace Terraria
{
  public class Dust
  {
      ...
      float Scale = 1f)
    {
      ...
      for (int index = 0; index < 6000; ++index)
      {
        ...
        if (!dust.active)
        {
          ...
          dust.frame.Height = 8;
          dust.rotation = 0.0f;
          dust.scale = (float) (1.0 + (double) Main.rand.Next(-20, 21) * 0.0099999997764825821);
          dust.scale *= Scale;
          dust.noLight = false;
    ...
    {
      return Dust.QuickDust(tileCoords.ToWorldCoordinates(), color);
    }
          ...
          if (dust.active)
          {
            ...
            if (dust.firstFrame && !ChildSafety.Disabled && ChildSafety.DangerousDust(dust.type))
            {
              if (Main.rand.Next(2) == 0)
              {
                ...
                dust.type = 16;
                dust.scale = (float) ((double) Main.rand.NextFloat() * 1.6000000238418579 + 0.30000001192092896);
            ...
            {
              dust.rotation = 0.0f;
              float num44 = (float) ((double) dust.scale / 2.5 * 0.20000000298023224);
            ...
            if (dust.type == 174)
            {
              ...
              if ((double) r > 0.60000002384185791)
                r = 0.6f;
            ...
            else if (dust.type == 304)
            {
              ...
              if ((double) dust.scale < 1.1499999761581421)
              {
              ...
              if (dust.type == 31)
              {
                ...
                if (dust.customData != null && dust.customData is NPC)
                {
                  ...
                  if (dust.alpha < 0)
                    dust.alpha = 0;
                  dust.scale *= 0.97f;
                  if ((double) dust.scale <= 0.0099999997764825821)
                  {
                    dust.scale = 0.0001f;
            ...
            else if (dust.type == 270)
            {
              ...
              {
                dust.velocity.Y = (float) Math.Sin((double) dust.position.X * 0.0043982295319437981) * 2f;
                dust.velocity.Y -= 3f;
                dust.velocity.Y /= 20f;
              }
            }
            ...
            else if (dust.type == 34 || dust.type == 35 || dust.type == 152)
            {
              ...
              if (dust.type == 35)
              {
                float r = (float) ((double) dust.scale * 0.30000001192092896 + 0.40000000596046448);
                if ((double) r > 1.0)
                  r = 1f;
                Lighting.AddLight((int) ((double) dust.position.X / 16.0), (int) ((double) dust.position.Y / 16.0), r, r * 0.5f, r * 0.3f);
              }
      ...
      switch (this.type)
      {
        ...
        default:
          ...
          if (this.type == 157)
          {
            ...
            int num5 = maxValue;
            int num6 = maxValue;
            float num7 = (float) ((double) Main.mouseTextColor / 100.0 - 1.6000000238418579);
